...
class RegisterRequest(_message.Message):
    __slots__ = ("cluster_token", "hostname", "worker_name", "cluster_name", "version")
    ...
    cluster_name: str
    version: str
    def __init__(self, cluster_token: _Optional[str] = ..., hostname: _Optional[str] = ..., worker_name: _Optional[str] = ..., cluster_name: _Optional[str] = ..., version: _Optional[str] = ...) -> None: ...
...
class InstanceStatus(_message.Message):
    __slots__ = ("instance_id", "state", "detail", "port")
    ...
    detail: str
    port: int
    def __init__(self, instance_id: _Optional[str] = ..., state: _Optional[str] = ..., detail: _Optional[str] = ..., port: _Optional[int] = ...) -> None: ...
...
class InstanceCommand(_message.Message):
    __slots__ = ("instance_id", "action", "config")
    INSTANCE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    action: str
    config: EngineConfig
    def __init__(self, instance_id: _Optional[str] = ..., action: _Optional[str] = ..., config: _Optional[_Union[EngineConfig, _Mapping]] = ...) -> None: ...
